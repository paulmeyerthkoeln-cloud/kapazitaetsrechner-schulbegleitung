...
describe('berechneThemenGantt', () => {
          ...
          reihen: [
            {
              ...
              einheiten: [
                { id: 'e1', index: 1, datum_oder_kw: '2026-09-08', kontaktzeit_h: 1.5, wir_begleiten: true, begleitperson_ids: [], koordinator_ids: [], thema: 'Mobilität' },
                { id: 'e2', index: 2, datum_oder_kw: '2026-09-15', kontaktzeit_h: 1.5, wir_begleiten: false, begleitperson_ids: [], koordinator_ids: [], thema: 'Mobilität' },
              ],
            },
          ],
        },
          ...
          reihen: [
            {
              ...
              einheiten: [
                { id: 'e1', index: 1, datum_oder_kw: '2026-11-09', kontaktzeit_h: 4, wir_begleiten: true, begleitperson_ids: [], koordinator_ids: [] },
              ],
            },
          ],
        },
          ...
          reihen: [
            {
              ...
              einheiten: [
                { id: 'e1', index: 1, datum_oder_kw: '2026-09-08', kontaktzeit_h: 1.5, wir_begleiten: true, begleitperson_ids: [], koordinator_ids: [], thema: 'Mobilität' },
                { id: 'e2', index: 2, datum_oder_kw: '2026-09-29', kontaktzeit_h: 1.5, wir_begleiten: true, begleitperson_ids: [], koordinator_ids: [], thema: 'Mobilität' },
              ],
            },
          ],
        },
          ...
          reihen: [
            {
              ...
              terminstatus: 'festgelegt',
              einheiten: [
                { id: 'e1', index: 1, datum_oder_kw: '2026-09-21', kontaktzeit_h: 1, wir_begleiten: true, begleitperson_ids: [], koordinator_ids: [], thema: 'Energie' },
              ],
            },
          ],
        },
          ...
          reihen: [
            {
              ...
              terminstatus: 'festgelegt',
              einheiten: [
                { id: 'e1', index: 1, datum_oder_kw: '2026-09-07', kontaktzeit_h: 1.5, wir_begleiten: true, begleitperson_ids: [], koordinator_ids: [], thema: 'Energie' },
              ],
            },
            {
              id: 'r2',
              ...
              terminstatus: 'festgelegt',
              einheiten: [
                { id: 'e2', index: 1, datum_oder_kw: '2026-09-07', kontaktzeit_h: 1.5, wir_begleiten: true, begleitperson_ids: [], koordinator_ids: [], thema: 'Energie' },
              ],
            },
          ],
        },
          ...
          reihen: [
            {
              ...
              terminstatus: 'offen',
              einheiten: [
                { id: 'e1', index: 1, datum_oder_kw: '2026-10-05', kontaktzeit_h: 1.5, wir_begleiten: true, begleitperson_ids: [], koordinator_ids: [] },
              ],
            },
          ],
        },
          ...
          reihen: [
            {
              ...
              terminstatus: 'festgelegt',
              einheiten: [
                { id: 'e1', index: 1, datum_oder_kw: '2026-09-14', kontaktzeit_h: 0, wir_begleiten: false, begleitperson_ids: [], koordinator_ids: [] },
              ],
            },
          ],
        },
          ...
          reihen: [
            {
              ...
              einheiten: [
                { id: 'e1', index: 1, datum_oder_kw: '2026-09-07', kontaktzeit_h: 1.5, wir_begleiten: true, begleitperson_ids: [], koordinator_ids: [], thema: 'Energie' },
                { id: 'e2', index: 2, datum_oder_kw: '2026-09-14', kontaktzeit_h: 1.5, wir_begleiten: true, begleitperson_ids: [], koordinator_ids: [], thema: 'Stadtgrün' },
              ],
            },
          ],
        },
  ...
  it('sorts rows by startWochenKey, then by zeilenLabel', () => {
    const reiheFuer = (id: string, datum: string) => ({
      ...
      einheiten: [
        { id: `${id}_e`, index: 1, datum_oder_kw: datum, kontaktzeit_h: 1, wir_begleiten: true, begleitperson_ids: [], koordinator_ids: [] },
      ],
    })
    const data: Datenbestand = {
      settings,
      ...
      veranstaltungen: [
        {
          ...
          schulIds: ['s1', 's2'],
          termine: [
            { id: 't1', index: 1, datum_oder_kw: '2026-11-09', kontaktzeit_h: 2, thema: 'Energie', besetzungen: [] },
          ],
        },
      ],
    }
      ...
      veranstaltungen: [
        {
          ...
          terminstatus: 'festgelegt',
          schulIds: ['s1'],
          termine: [{ id: 't1', index: 1, datum_oder_kw: '2026-11-09', kontaktzeit_h: 2, besetzungen: [] }],
        },
      ],
    }
    expect(berechneThemenGantt(data)).toEqual([])
